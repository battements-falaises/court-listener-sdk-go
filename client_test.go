...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Courts.List(context.Background(), courtlistenersdk.CourtListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Courts.List(cancelCtx, courtlistenersdk.CourtListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Courts.List(deadlineCtx, courtlistenersdk.CourtListParams{})
		if err == nil {
