...
// RequestOption is an option for the requests made by the court-listener API Client
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://www.courtlistener.com/api/rest/v4/")
}
...
func WithAPIKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.APIKey = value
		return r.Apply(WithHeader("authorization", fmt.Sprintf("Token %s", r.APIKey)))
	})
}
