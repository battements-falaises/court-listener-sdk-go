...
// interacting with the court-listener API. You should not instantiate this client
...
// DefaultClientOptions read from the environment (COURT_LISTENER_API_KEY,
...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("COURT_LISTENER_API_KEY"); ok {
		defaults = append(defaults, option.WithAPIKey(o))
	}
	if o, ok := os.LookupEnv("COURT_LISTENER_USERNAME"); ok {
...
// environment (COURT_LISTENER_API_KEY, COURT_LISTENER_USERNAME,
// COURT_LISTENER_PASSWORD, COURT_LISTENER_BASE_URL). The option passed in as
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.Courts = NewCourtService(opts...)
	r.Dockets = NewDocketService(opts...)
	r.Clusters = NewClusterService(opts...)
	r.Opinions = NewOpinionService(opts...)
